...
// connect views to variables
        ...
        //Listener for the button and also has an animation
    ...
    //its used to save the current state for use with another state
    ...
    // its called to destroy the activity
...
//Tracks variable we want to save when orientation changes
    companion object {
